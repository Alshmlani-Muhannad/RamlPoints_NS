const translations = {
    en: {
        ...
        step_3: "Confirmation",
        Choose_program_1: "Choose the program you want to convert points from",
        alrajhi: "Al Rajhi Bank Rewards",
        Alrajhi_Points: "0.0039 SAR/point",
        Alrajhi_Points1: "Min: 1,000 points | Fee: 50%",
        Qitaf_r: "Qitaf (STC)",
        Qitaf_Points: "0.16 SAR/point",
        Qitaf_Points1: "Min: 50 points | Fee: 50%",
        Akther_r: "Akther Alinma",
        Akther_Points: "0.0028 SAR/point",
        Akther_Points1: "Min: 500 points | Fee: 50%",
        ANB_r: "ANB Rewards",
        ANB_Points: "0.01 SAR/point",
        ANB_Points1: "Min: 500 points | Fee: 50%",
        IZ_r: "IZ Wallet Program",
        Iz_points: "0.0016 SAR/point",
        Iz_points1: "Min: 1,000 points | Fee: 20%",
        BSF_r: "BSF Jana Points",
        BSF_Points: "0.004 SAR/point",
        BSF_Points1: "Min: 1,200 points | Fee: 15%",
        Continue_to_Account_Details: "Continue to Account Details",
        Provide_your_account: "Provide your account details and points balance",
        Phone_Numberl: "Phone Number *",
        Program_name1: "Program Name *",
        Autofill: "✓ Automatically filled based on your program selection",
        bank_name: "Bank Name *",
        Points_Balance: "Points Balance *",
        Account_Points_info: "Account & Points Information",
        select_program: "Select Your Loyalty Program",
        points_to_convert: "Points to Convert",
        account_details: "Account Information",
        phone_number: "Phone Number",
        program_account: "Program Account",
        points_balance: "Points Balance",
        bank_details: "Bank Account Details",
        iban_number: "IBAN *",
        twentyfour_digit: "Your 24-digit Saudi IBAN starting with SA",
        Select_catagory: "Select your bank",
        Alrajhi_choose: "Al Rajhi Bank",
        SABB: "SABB",
        alahli: "SNB Alahli",
        ...
        bank_grade_security_desc: "Your data is encrypted and protected with the same security standards used by major banks.",
        fast_processing:          "Fast Processing",
        fast_processing_desc:     "Most requests are processed within 3-5 business days with real-time status updates.",
        support_24_7:             "24/7 Support",
        support_24_7_desc:"Get help anytime through WhatsApp or our support channels. We're here to assist you.",
        ...
        processing_fee: "Processing Fee",
        estimated_cash: "Estimated Cash Value",
        net_amount: "Net Amount",
        summary_title: "Request Summary",
        summary_points: "Points to Convert",
        summary_rate: "Conversion Rate",
        success_title: "Request Submitted Successfully!",
        success_message: "Thank you for choosing RamlPoints. Your conversion request has been received and is being processed.",
        track_status: "Track Status",
        new_request: "New Request",
        security_encryption: "Bank-Grade Security",
        instant_processing: "Fast Processing",
    ...
    ar: {
        ...
        step_3: "التأكيد",
        select_program: "اختر برنامج الولاء الخاص بك",
        Choose_program_1: "اختر البرنامج الذي تريد تحويل النقاط منه",
        alrajhi: "نقاط بنك الراجحي",
        Alrajhi_Points: "0.0039 ريال سعودي/نقطة",
        Alrajhi_Points1: "الحد الأدنى: ١٠٠٠ نقطة | الرسوم: ٥٠٪",
        Qitaf_r: "قطاف (STC)",
        Qitaf_Points: "0.16 ريال سعودي/نقطة",
        Qitaf_Points1: "الحد الأدنى: ٥٠ نقطة | الرسوم: ٥٠٪",
        Akther_r: "أكثر الإنماء",
        Akther_Points: "0.0028 ريال سعودي/نقطة",
        Akther_Points1: "الحد الأدنى: ٥٠٠ نقطة | الرسوم: ٥٠٪",
        ANB_r: "مكافآت البنك العربي الوطني",
        ANB_Points: "0.01 ريال سعودي/نقطة",
        ANB_Points1: "الحد الأدنى: ٥٠٠ نقطة | الرسوم: ٥٠٪",
        IZ_r: "برنامج محفظة IZ",
        Iz_points: "0.0016 ريال سعودي/نقطة",
        Iz_points1: "الحد الأدنى: ١٠٠٠ نقطة | الرسوم: ٢٠٪",
        BSF_r: "نقاط جنى البنك الفرنسي السعودي",
        BSF_Points: "0.004 ريال سعودي/نقطة",
        BSF_Points1: "الحد الأدنى: ١٢٠٠ نقطة | الرسوم: ١٥٪",
        Continue_to_Account_Details: "متابعة إلى تفاصيل الحساب",
        Provide_your_account: "قم بتقديم تفاصيل حسابك ورصيد النقاط",
        Phone_Numberl: "رقم الجوال *",
        Program_name1: "اسم البرنامج *",
        Autofill:"✓ يتم ملؤها تلقائيًا بناءً على اختيار البرنامج الخاص بك",
        Points_Balance: "رصيد النقاط *",
        Account_Points_info: "معلومات الحساب والنقاط",
        points_to_convert: "النقاط المراد تحويلها",
        account_details: "معلومات الحساب",
        phone_number: "رقم الجوال",
        program_account: "حساب البرنامج",
        points_balance: "رصيد النقاط",
        bank_details: "تفاصيل الحساب البنكي",
        bank_name: "اسم البنك *",
        iban_number: "رقم الآيبان *",
        twentyfour_digit: "٢٤ رقمًا تبدأ بـ SA",
        Select_catagory: "اختر البنك المراد التحويل عليه",
        Alrajhi_choose: "الراجحي",
        SABB: "ساب",
        alahli: "الأهلي",
        Riyad_Bank: "بنك الرياض",
        Alinma_bank: "الإنماء",
        Arab_national: "العربي الوطني",
        Banque_Saudi: "البنك الفرنسي السعودي",
        Saudi_investement: "السعودي للاستثمار",
        other: "أخرى",
        Minimum_points: "الحد الأدنى للنقاط للتحويل:",
        Conersion_estimate: "تقدير التحويل:",
        bank_grade_security:      "أمان مصرفي عالمي",
        bank_grade_security_desc: "بياناتك مشفرة ومحمية بمعايير الأمان ذاتها التي تستخدمها أكبر البنوك.",
        fast_processing:          "معالجة سريعة",
        fast_processing_desc:     "تُعالج أغلب الطلبات خلال ٣-٥ أيام عمل مع تحديثات فورية للحالة.",
        support_24_7:             "دعم على مدار الساعة",
        support_24_7_desc:        "احصل على المساعدة في أي وقت عبر واتساب أو قنوات الدعم الخاصة بنا، نحن في خدمتك.",
        Points_to_convert: "النقاط المراد تحويلها",
        conversion_estimate: "تقدير التحويل",
        points_to_convert: "النقاط للتحويل:",
        conversion_rate: "سعر التحويل:",
        gross_value: "القيمة الإجمالية:",
        processing_fee: "رسوم المعالجة:",
        net_amount: "المبلغ الصافي:",
        net_after_fee: "الصافي بعد الرسوم:",
        review_request: "مراجعة طلبك",
        terms_agreement: "أوافق على شروط الخدمة",
        privacy_agreement: "أوافق على سياسة الخصوصية",
        submit_request: "تقديم الطلب",
        processing_fee: "رسوم المعالجة",
        estimated_cash: "القيمة النقدية المقدرة",
        net_amount: "المبلغ الصافي",
        summary_title: "ملخص الطلب",
        summary_points: "النقاط المراد تحويلها",
        summary_rate: "معدل التحويل",
        success_title: "تم تقديم الطلب بنجاح!",
        success_message: "شكراً لاختيارك رمل بوينتس. تم استلام طلب التحويل الخاص بك وجاري معالجته.",
        track_status: "تتبع الحالة",
        new_request: "طلب جديد",
        security_encryption: "أمان من الدرجة المصرفية",
        instant_processing: "معالجة سريعة",
        ...
        // Homepage Hero Section
        trustedBy: "موثوق من قبل مجموعة ",
        heroTitle: "حول نقاط الولاء<br />غير المستخدمة<br />إلى نقد حقيقي",
        heroSubtitle: "حول مكافآت البنوك والمحافظ إلى تحويلات نقدية فورية أو خصم كبير من مواقعنا. بسيط وآمن وشفاف - مدعوم بخدمات مجموعة رمل المالية الموثوقة.",
        ...
        // RamlGroup Section
        poweredBy: "مدعوم من مجموعة رمل",
        trustTitle: "خدمات مالية موثوقة منذ 2022",
        trustDesc: "رمل بوينتس جزء من نظام مجموعة رمل البيئي، يجلب لك نفس الموثوقية والأمان الذي يثق به آلاف العملاء السعوديين لاحتياجاتهم التقنية.",
        highEncryption: "خوارزميات تشفير عالية",
        bankGradeSecurity: "أمان وتشفير بدرجة المعلومات",
        support247: "دعم العملاء 24/7 عبر واتساب",
        learnAboutRaml: "تعلم حول مجموعة رمل",
        ...
        nav_about: "حول مجموعة رمل",
        nav_contact: "اتصل بنا",
        legal: "قانوني",
        terms_privacy: "الشروط والخصوصية",
        copyright: "© 2025 مجموعة رمل. جميع الحقوق محفوظة. | مدعوم بحلول تقنية مبتكرة.",

        //about_raml_group.html
        servicesTitle: "نظام خدمات مجموعة رمل البيئي",
        ...
        aboutTitle: 'حول <span class="text-accent">مجموعة رمل</span><br />الريادة في التكنولوجيا',
        aboutSubtitle: "منذ عام 2020، كانت مجموعة رمل في المقدمة من الابتكار التكنولوجي في المملكة العربية السعودية، مما يمكن السوق من اكتشاف خدمات جديدة من خلال حلول آمنة وشفافة ومبتكرة.",
        ...
        acceptanceTermsContent: "من خلال الوصول واستخدام خدمات رمل بوينتس المقدمة من مجموعة رمل فإنك تقبل وتوافق على الالتزام بشروط وأحكام هذه الاتفاقية. إذا كنت لا توافق على الالتزام بما ورد أعلاه، يرجى عدم استخدام هذه الخدمة.",
        serviceDescription: "2. وصف الخدمة",
        serviceDescriptionContent: "رمل بوينتس هي خدمة تحويل نقاط الولاء التي تسمح للمستخدمين بتحويل نقاط برامج الولاء غير المستخدمة من البنوك السعودية ومقدمي خدمات الاتصالات المشاركين إلى تحويلات نقدية. برامجنا المدعومة تشمل:",
